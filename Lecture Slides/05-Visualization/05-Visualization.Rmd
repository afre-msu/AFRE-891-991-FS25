...
knitr::include_graphics("images/owid_emissions.png")
```
]
---
...
knitr::include_graphics("images/wsj-vaccines-example-1.png")
```
]
...
knitr::include_graphics("images/zika.png")
```
]
...
Decide, then build your plot around that message.
  ...
  - .hi-medgrn[Remove the clutter]: get rid of any features of the visualization that .hi-medgrn[do not contribute] to the .hi-medgrn[central message].
...
knitr::include_graphics("images/scatter_bad.png")
```
  ]
...
# Reduce the Clutter
  ...
  .center[
```{r, echo = F, out.width= "650"}
knitr::include_graphics("images/scatter_good.png")
```
  ]
...
#  Violating the Area Principle
  ...
  .center[
```{r, echo = F, out.width= "750"}
knitr::include_graphics("images/foxnews_border.jpg")
```
  ]
...
# Violating the Area Principle
  ...
  .center[
```{r, echo = F, out.width= "750"}
knitr::include_graphics("images/venez.png")
```  
  ]
...
# Violating the Area Principle (Again)
  ...
  .center[
```{r, echo = F, out.width= "750"}
knitr::include_graphics("images/state-of-the-union.png")
```
  ]
