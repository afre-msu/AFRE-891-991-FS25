...
```{r echo = FALSE}
knitr::include_graphics("images/rmd_add.png")
```
...
```{r echo = FALSE}
knitr::include_graphics("images/rmd_add2.png")
```
...
```{r echo = FALSE}
knitr::include_graphics("images/rmd_add3.png")
```
...
knitr::include_graphics("images/chunk_opts.png")
```
...
.hi-slate[default] 
```{r, echo = F, out.width = "80%"}
knitr::include_graphics("images/class_def.png")
```
]
...
```{r, echo = F, out.width = "80%"}
knitr::include_graphics("images/class_primary.png")
```
]
...
```{r, echo = F, out.width = "80%"}
knitr::include_graphics("images/class_success.png")
```
]
...
```{r, echo = F, out.width = "80%"}
knitr::include_graphics("images/class_info.png")
```
]
...
```{r, echo = F, out.width = "80%"}
knitr::include_graphics("images/class_warning.png")
```
]
...
```{r, echo = F, out.width = "80%"}
knitr::include_graphics("images/class_danger.png")
```
]
...
```{r, echo = F, out.width = "120%"}
knitr::include_graphics("images/r_setup.png")
```
...
```{r, echo = F, out.width = "120%"}
knitr::include_graphics("images/rmd_knit2.png")
```
...
.center[
```{r, echo = F, out.width= "100%"}
knitr::include_graphics("images/stage_desktop.png")
```
]
...
.center[
```{r, echo = F, out.width= "100%"}
knitr::include_graphics("images/edit_github_0.png")
```
]
