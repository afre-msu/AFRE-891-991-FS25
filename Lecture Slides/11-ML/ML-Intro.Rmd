...
author: "James Sears* <br> AFRE 891/991 FS25 <br> Michigan State University"
...
1. [Decision Trees and Forests](#trees)

1. [Machine Learning for Causal Treatment Effect Estimation](#causal)

**Part 3: Additional Resources (Not Covered)**
...
Some of the common motivations for delving into ML methods include

--

- Interactions and .hi-medgrn[nonlinearities] likely matter
- Identifying which features/variables are important
...
This lecture we're going to do an overview of how to use machine learning in the form of .hi-green[Regression Trees and Forests:] 

* Ensemble method for fitting many conditional objects of interest
* Ask questions like: are there differences in conditional means (treatment effects) across the covariate space? What variable are most important for informing these differences?
